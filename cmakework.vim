...
set ruler
set runtimepath=~/.vim,~/.vim/bundle/Vundle.vim,~/.vim/bundle/YouCompleteMe,~/.vim/bundle/vim-fugitive,~/.vim/bundle/command-t,~/.vim/bundle/plugin,~/.vim/bundle/sparkup/vim/,/usr/share/vim/vimfiles,/usr/share/vim/vim82,/usr/share/vim/vimfiles/after,~/.vim/after,~/.vim/bundle/Vundle.vim,~/.vim/bundle/Vundle.vim/after,~/.vim/bundle/YouCompleteMe/after,~/.vim/bundle/vim-fugitive/after,~/.vim/bundle/command-t/after,~/.vim/bundle/plugin/after,~/.vim/bundle/sparkup/vim//after
set scrolloff=5
...
silent only
silent tabonly
cd ~/Documents/Github/test-cobre
...
3
normal! 020|
lcd ~/Documents/Github/test-cobre
tabnext
edit ~/Documents/Github/test-cobre/CMakeLists.txt
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
lcd ~/Documents/Github/test-cobre
tabnext
edit ~/Documents/Github/test-cobre/src/main/CMakeLists.txt
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
tabnext 2
set stal=1
badd +15 ~/Documents/Github/test-cobre/CMakeLists.txt
badd +0 ~/Documents/Github/test-cobre/src/CMakeLists.txt
badd +1 ~/Documents/Github/test-cobre/src/main/CMakeLists.txt
